# Almari
Bangkit Academy 2022 Captsone Project, This project classify fashion model into 46 fashion classes using [Deepfashion dataset](https://mmlab.ie.cuhk.edu.hk/projects/DeepFashion.html) and 10 fashion color using [Deepfashion dataset](https://mmlab.ie.cuhk.edu.hk/projects/DeepFashion.html) and some picture we find on the internet.
